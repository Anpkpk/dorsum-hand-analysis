...
\section{Cơ sở thuật toán nhánh phân tích mạch máu}

\subsection{Thuật toán chiếu ảnh cường độ tối đa}
...
\begin{figure}[h]
    ...
    \caption{Minh họa thuật toán MIP trong trích xuất mạng lưới mạch máu từ khối dữ liệu 3D}
...
\subsection{Thuật toán phân ngưỡng nhị phân}
...
Quá trình chuyển đổi được thực hiện bằng cách so sánh cường độ sáng của từng điểm ảnh $I(x, y)$ tại vị trí tọa độ $(x, y)$ với một giá trị ngưỡng cường độ cố định $T$ (chọn trước dựa trên thực nghiệm hoặc giải thuật tối ưu, ví dụ: $T = 42$). Hàm toán học phân ngưỡng được định nghĩa như sau:
...
\subsection{Tính toán Mật độ mạch máu}
...
\section{Phân tích kết cấu mô bằng ma trận GLCM}
