...
\begin{itemize}
    \item Áp dụng phép đếm nguyên tử (\code{atomicAdd}), hệ thống ghi nhận có \textbf{649.011} điểm ảnh thuộc hệ thống mạch máu.
    \item Tỷ lệ Mật độ mạch máu (Vessel Density) đo được trên toàn bề mặt là: \textbf{31.69\%}.
\end{itemize}
...
\begin{itemize}
    \item Thuật toán phân ngưỡng hiện tại đang sử dụng một giá trị cố định (Hardcoded Threshold $= 45$). Điều này có thể không chính xác nếu áp dụng lên các bộ dữ liệu ảnh y khoa khác có điều kiện ánh sáng và độ tương phản khác nhau.
